...
const FeatureSection = () => {
  const features = [
    {
      icon: <FaShippingFast size={40} style={{ color: '#000000' }} />,
      title: 'Free Shipping',
      subtitle: 'When you spend $100+',
    },
    {
      icon: <FaUsers size={40} style={{ color: '#000000' }} />,
      title: 'Feedbacks',
      subtitle: '100% Customer',
    },
    {
      icon: <FaRedo size={40} style={{ color: '#000000' }} />,
      title: 'Free Return',
      subtitle: '30 Day Returns Policy',
    },
    {
      icon: <FaLock size={40} style={{ color: '#000000' }} />,
      title: 'Secure System',
      subtitle: '100% Secure Guarantee',
    },
    {
      icon: <FaHeadset size={40} style={{ color: '#000000' }} />,
